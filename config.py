...
class Config:
    ...
    def createFile(self):
        ...
        self.config_parser['ports'] = {'gps_serial_port':'/dev/ttyACM0','sim_serial_port':'/dev/ttyS0','pir1_gpio_port': 17,'pir2_gpio_port': 27,'pir3_gpio_port': 22,'buzzer_gpio_port': 23,'sim_power_gpio_port': 24,'car_power_gpio_port': 25}
